pipeline {
    agent any
    environment {
        TF_VAR_gcp_project = "qwiklabs-gcp-01-874858c43416"
        TF_VAR_bucket = "tf-remote-state-student_04_ff71303a01eb-9562-12756"
        REPOSITORY = "https://github.com/cboullos/sample-awx-project.git" 
